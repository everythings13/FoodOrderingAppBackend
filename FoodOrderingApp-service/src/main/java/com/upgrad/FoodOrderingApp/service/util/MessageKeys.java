...
public final class MessageKeys {
    ...
    public static final String INVALID_CONTACT_NUMBER =
    ...
    public static final String INCORRECT_OLD_PASSWORD =
            "Incorrect old password!";

    public static final String NO_FIELD_SHOULD_BE_EMPTY =
    ...
    public static final String MISSING_INVALID_TOKEN =
