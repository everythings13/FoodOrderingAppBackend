...
public class CustomerService {
  ...
  public CustomerEntity saveCustomer(CustomerEntity customerEntity)
    ...
    String encryptedPassword =
        PasswordCryptographyProvider.encrypt(
            customerEntity.getPassword(), customerEntity.getSalt());
  ...
  public CustomerEntity updateCustomerPassword(
      String old_password, String new_password, CustomerEntity customerEntity)
      throws UpdateCustomerException {

    String oldEncryptedPassword =
        PasswordCryptographyProvider.encrypt(old_password, customerEntity.getSalt());
    String newEncryptedPassword =
        PasswordCryptographyProvider.encrypt(new_password, customerEntity.getSalt());
